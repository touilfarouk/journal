...
\hyperref[sec:intro]{\footnotesize Introduction : pourquoi Compose change tout} \dotfill & {\footnotesize \textcolor{darkgray}{{1}}} \\
\hyperref[sec:chapter-1]{\footnotesize Créer notre premier projet Compose} \dotfill & {\footnotesize \textcolor{darkgray}{{4}}}\\
\hspace{1.5em}\hyperref[subsec:composable-lifecycle]{\footnotesize Le cycle de vie d'un composable} \dotfill & {\footnotesize \textcolor{darkgray}{\pageref{subsec:composable-lifecycle}}}\\
