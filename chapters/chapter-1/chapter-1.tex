...
\begin{minipage}[t]{0.48\linewidth}
  ...
  {\footnotesize
  \textcolor{darkgray}{
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel sagittis lorem. Vivamus nisi turpis, pulvinar non purus vel, aliquet congue tortor.
  }}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
  \vspace{0pt}%
  {\footnotesize
  \textcolor{darkgray}{
  Donec ligula felis, iaculis ut interdum id, egestas sit amet nisi. Praesent at libero ligula. Phasellus mattis, arcu at posuere commodo, lectus turpis auctor risus.
  }}
\end{minipage}
