...
% \begin{center}
%     \includegraphics[width=0.35\linewidth]{images/chapter-1/counter-app.png}\\[0.4em]
%     {\footnotesize\textcolor{darkgray}{Aperçu du résultat final de l'application compteur, correspondant au code complet présenté ci-dessous.}}
% \end{center}
